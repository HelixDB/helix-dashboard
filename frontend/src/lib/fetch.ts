...
// Default configuration options applied to all swiftFetch requests.
...
// Configures global default settings for all swiftFetch requests.
...
// Prepares the URL for a fetch request by conditionally building complex URLs or using provided ones.
...
// Prepare fetch options with headers, credentials, and body - O(1)
